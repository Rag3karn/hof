import BengaluruLeaderboard from "@/components/BengaluruLeaderboard";
import GamesPlayed from "@/components/GamesPlayed";
import Rewards from "@/components/Rewards";
import { useBengaluruRealtimeData } from "@/hooks/useBengaluruRealtimeData";
import hofLogo from "@/assets/hof-logo.png";

export default function Bengaluru() {
  const { players, gamesCount, loading } = useBengaluruRealtimeData();
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <BengaluruLeaderboard players={players} />
          </div>
          
          {/* Sidebar */}
          <div className="space-y-6">
            <GamesPlayed count={gamesCount} startDate="24th August" />
            <Rewards />
          </div>
        </div>
      </div>
