...
interface BengaluruLeaderboardProps {
  players: BengaluruPlayer[];
}

export default function BengaluruLeaderboard({ players }: BengaluruLeaderboardProps) {
  return (
    <Card className="p-6">
      <h2 className="text-2xl font-bold mb-4 text-green-400">Bengaluru Leaderboard</h2>
