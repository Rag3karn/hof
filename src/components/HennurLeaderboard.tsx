...
interface HennurLeaderboardProps {
  players: HennurPlayer[];
}

export default function HennurLeaderboard({ players }: HennurLeaderboardProps) {
  return (
    <Card className="p-6">
      <h2 className="text-2xl font-bold mb-4 text-green-400">Hennur Leaderboard</h2>
